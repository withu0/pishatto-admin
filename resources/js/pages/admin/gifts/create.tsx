...
export default function CreateGift({ categories }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post('/admin/gifts', formData, {
            onError: (errors) => {
                setErrors(errors);
            },
            onSuccess: () => {
        ...
        <AppLayout>
            ...
            <div className="container mx-auto py-6">
                <div className="flex items-center mb-6">
                    ...
                    <h1 className="text-3xl font-bold">ギフト作成</h1>
                </div>

                <Card className="max-w-2xl">
                    <CardHeader>
                        <CardTitle>新しいギフトを作成</CardTitle>
                    </CardHeader>
                    <CardContent>
