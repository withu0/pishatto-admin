...
export default function EditBadge({ badge }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.put(`/admin/badges/${badge.id}`, formData, {
            onError: (errors) => {
                setErrors(errors);
            },
            onSuccess: () => {
        ...
        <AppLayout>
            ...
            <div className="container mx-auto py-6">
                <div className="flex items-center mb-6">
                    ...
                    <h1 className="text-3xl font-bold">バッジ編集</h1>
                </div>

                <Card className="max-w-2xl">
                    <CardHeader>
                        <CardTitle>バッジを編集</CardTitle>
                    </CardHeader>
                    <CardContent>
