...
export default function CreateTweet() {
    const { guests, casts } = usePage<PageProps>().props;
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post(route('admin.tweets.store'));
    };

    return (
        <AppLayout breadcrumbs={[
            { title: 'つぶやき管理', href: route('admin.tweets.index') },
            { title: '新規作成', href: route('admin.tweets.create') }
        ]}>
            <Head title="つぶやき新規作成" />
            <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <h1 className="text-2xl font-bold">つぶやき新規作成</h1>
                </div>
